       ...
       <div class="item-list-wrap confirm-item-list-wrap">
         <div class="cart-item order-item">
           ...
           <ul class="cart-item-list">
             <li v-for="goods in orderList" v-if="goods.checked == 1">
               <div class="cart-tab-1">
                 <div class="cart-item-pic">
                   <img v-bind:src="'./../../static/'+goods.productImage" alt="">
                 </div>
               ...
               <div class="cart-tab-2">
                 <div class="item-price">{{goods.salePrice | currency('￥')}}</div>
               </div>
               ...
               <div class="cart-tab-4">
                 <div class="item-price-total">{{goods.productNum*goods.salePrice | currency('$')}}</div>
               </div>
             </li>
           </ul>
         </div>
  ...
  computed:{
      totalPrice(){
          ...
          this.orderList.forEach((goods)=>{
              if(goods.checked == 1){
                  money += goods.productNum*goods.salePrice;
              }
          })
          return money;
      },
