...
<template>
  <div>
     ...
     <div class="container">
       <div class="checkout-addr">
         ...
         <div class="addr-list-wrap">
           <div class="addr-list">
             <ul>
               <li v-for="(address,index) in addressListFilter" v-bind:class="{'check' : checkIndex == index}" @click="checkIndex = index;selectedAddrId = address.addressId">
                 <dl>
                 ...
                 <div class="addr-opration addr-del">
                   <a href="javascript:;" class="addr-del-btn" @click="delAddressConfirm(address.addressId)">
                     <svg class="icon icon-del"><use xlink:href="#icon-del"></use></svg>
                   </a>
                 </div>
                 <div class="addr-opration addr-set-default">
                   <a href="javascript:;" class="addr-set-default-btn" v-if="!address.isDefault" @click="setDefault(address.addressId)"><i>Set default</i></a>
                 </div>
    ...
    <modal v-bind:mdShow="delFail" v-on:close="closeModal">
          <p slot="message">
            地址列表至少需要一条数据,无法继续删除
          </p>
          <div slot="btnGroup">
    ...
    <modal v-bind:mdShow="delSuc" v-on:close="closeModal">
          <p slot="message">
            地址删除成功!
          </p>
          <div slot="btnGroup">
    ...
    <modal v-bind:mdShow="modalConfirm" v-on:close="closeModal">
      ...
      <div slot="btnGroup">
        <a class='btn btn--m' @click="delAddress" href="javascript:;">确认</a>
